...
file1 <- read.table(file="/Users/sidneibarbieri/Desktop/Projeto v_07/_Entrada CSV/moises/ataques_full.csv", header=TRUE, sep=",")  
# experimentos individuais
#file1 <- read.table(file="/Users/sidneibarbieri/Desktop/Projeto v_07/_Entrada CSV/Artigo/ackscan.csv", header=TRUE, sep=",")  
...
#write.csv(tcpdf, file="/Users/sidneibarbieri/Desktop/Projeto v_07/_Saída CSV/weka_exp4_complementar.csv") #weka
############################################################################################################
# Análises estatísticas
#tcdfEst <-  tcpdfR2 %>% filter(Probe == TRUE) 
#write.csv2(tcdfEst, file="/Users/sidneibarbieri/Desktop/Projeto v_07/_Saída CSV/excel.csv") # Excel
############################################################################################################